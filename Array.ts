...
let names:string[] = ["habiba","khizra","wajeeha"]

function pushNewValue(newName:string){
    names[3] = newName;
...
let studentName:string[] = ["khizar","Ali","Habiba"]

function pushNewElement(newStudent:string){
